...
* **Manual robots.txt:**  
Requests well-behaved AI bots avoid specific sections while allowing full script access (JS/CSS) for accurate rendering. Note on manual robots.txt. The SEO Framework typically renders a robot.txt but will respect a physical file.
